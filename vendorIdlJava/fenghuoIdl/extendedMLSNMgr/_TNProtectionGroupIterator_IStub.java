...
public class _TNProtectionGroupIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedMLSNMgr.TNProtectionGroupIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedMLSNMgr/TNProtectionGroupIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedMLSNMgr.TNProtectionGroupIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			TNProtectionGroupIterator_IOperations _localServant = (TNProtectionGroupIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedMLSNMgr.TNProtectionGroupList_THolder tNetworkProtectGroupList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				tNetworkProtectGroupList.value = extendedMLSNMgr.TNProtectionGroupList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,tNetworkProtectGroupList);
			}
			finally
			{
				_servant_postinvoke(_so);
