	...
	implements org.omg.CORBA.portable.InvokeHandler, extendedMLSNMgr.ExtendedMLSNMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getMLSNBackBoneRoute", new java.lang.Integer(5));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(6));
		m_opsHash.put ( "setMLSNPPLinkSRLGs", new java.lang.Integer(7));
		m_opsHash.put ( "performTnpProtectionCommand", new java.lang.Integer(8));
	...
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedMLSNMgr/ExtendedMLSNMgr_I:1.0","IDL:mtnm.tmforum.org/common/Common_I:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				topologicalLink.TopologicalLinkList_THolder _arg3= new topologicalLink.TopologicalLinkList_THolder();
				topologicalLink.TopologicalLinkIterator_IHolder _arg4= new topologicalLink.TopologicalLinkIterator_IHolder();
				_out = handler.createReply();
				getMLSNBackBoneRoute(_arg0,_arg1,_arg2,_arg3,_arg4);
				topologicalLink.TopologicalLinkList_THelper.write(_out,_arg3.value);
				topologicalLink.TopologicalLinkIterator_IHelper.write(_out,_arg4.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 8: // performTnpProtectionCommand
			{
			try
			{
