...
public abstract class TCAParameterProfileIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, performance.TCAParameterProfileIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				performance.TCAParameterProfileList_THolder _arg1= new performance.TCAParameterProfileList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				performance.TCAParameterProfileList_THelper.write(_out,_arg1.value);
			}
