	...
	implements org.omg.CORBA.portable.InvokeHandler, performance.PerformanceManagementMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "enableTCA", new java.lang.Integer(15));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(16));
		...
		m_opsHash.put ( "getAllPMPNames", new java.lang.Integer(20));
		m_opsHash.put ( "getTCATPParameter", new java.lang.Integer(21));
		m_opsHash.put ( "setTCAParameterProfilePointer", new java.lang.Integer(22));
		m_opsHash.put ( "deleteTCAParameterProfile", new java.lang.Integer(23));
		m_opsHash.put ( "getTPHistoryPMData", new java.lang.Integer(24));
		m_opsHash.put ( "clearPMData", new java.lang.Integer(25));
		m_opsHash.put ( "getAllTCAParameterProfileNames", new java.lang.Integer(26));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 22: // setTCAParameterProfilePointer
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 23: // deleteTCAParameterProfile
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 26: // getAllTCAParameterProfileNames
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
