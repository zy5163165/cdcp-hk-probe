...
public final class AlarmOrTCAIdentifier_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			...
			members[1] = new org.omg.CORBA.UnionMember ("alarmId", label_any, notifications.AlarmId_THelper.type(),null);
			label_any = org.omg.CORBA.ORB.init().create_any ();
			notifications.AlarmTypeQualifier_THelper.insert(label_any, notifications.AlarmTypeQualifier_T.TCA);
			members[0] = new org.omg.CORBA.UnionMember ("tcaId", label_any, notifications.TCAId_THelper.type(),null);
