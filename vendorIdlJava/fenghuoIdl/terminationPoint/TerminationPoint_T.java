	...
	public String toString() {
		...
		if (name!=null) {
			for (int i=0;i<name.length;i++) {
				globaldefs.NameAndStringValue_T t=name[i];
				nameStr+="name="+t.name+" ;value="+t.value+" ;";
			}
		}
		
		return "TerminationPoint_T ["+nameStr+"]"
				...
				+ Arrays.toString(egressTrafficDescriptorName) + ", type="
				+ type + ", connectionState=" + connectionState
				+ ", tpMappingMode=" + tpMappingMode + ", direction="
				+ direction + ", transmissionParams="
