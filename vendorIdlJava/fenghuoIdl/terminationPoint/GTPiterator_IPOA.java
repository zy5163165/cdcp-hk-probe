...
public abstract class GTPiterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, terminationPoint.GTPiterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				terminationPoint.GTPlist_THolder _arg1= new terminationPoint.GTPlist_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				terminationPoint.GTPlist_THelper.write(_out,_arg1.value);
			}
