...
public class _GTPiterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements terminationPoint.GTPiterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/terminationPoint/GTPiterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = terminationPoint.GTPiterator_IOperations.class;
	public boolean next_n(int how_many, terminationPoint.GTPlist_THolder gtpList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			GTPiterator_IOperations _localServant = (GTPiterator_IOperations)_so.servant;
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,gtpList);
			}
			finally
			{
