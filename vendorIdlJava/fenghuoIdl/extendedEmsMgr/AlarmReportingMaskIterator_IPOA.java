...
public abstract class AlarmReportingMaskIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, extendedEmsMgr.AlarmReportingMaskIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				extendedEmsMgr.AlarmReportingMaskList_THolder _arg1= new extendedEmsMgr.AlarmReportingMaskList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				extendedEmsMgr.AlarmReportingMaskList_THelper.write(_out,_arg1.value);
			}
