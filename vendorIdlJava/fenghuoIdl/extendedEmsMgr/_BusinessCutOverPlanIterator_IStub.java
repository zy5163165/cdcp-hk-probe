...
public class _BusinessCutOverPlanIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedEmsMgr.BusinessCutOverPlanIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedEmsMgr/BusinessCutOverPlanIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedEmsMgr.BusinessCutOverPlanIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			BusinessCutOverPlanIterator_IOperations _localServant = (BusinessCutOverPlanIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedEmsMgr.BusinessCutOverPlanList_THolder bcoPlanList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,bcoPlanList);
			}
			finally
			{
				_servant_postinvoke(_so);
