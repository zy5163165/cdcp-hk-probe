...
public class _AlarmFilterTaskIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedEmsMgr.AlarmFilterTaskIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedEmsMgr/AlarmFilterTaskIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedEmsMgr.AlarmFilterTaskIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			AlarmFilterTaskIterator_IOperations _localServant = (AlarmFilterTaskIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedEmsMgr.AlarmFilterTaskList_THolder alarmFilterMaskList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				alarmFilterMaskList.value = extendedEmsMgr.AlarmFilterTaskList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,alarmFilterMaskList);
			}
			finally
			{
				_servant_postinvoke(_so);
