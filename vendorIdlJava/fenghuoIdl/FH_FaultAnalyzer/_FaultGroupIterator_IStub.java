...
public class _FaultGroupIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements FH_FaultAnalyzer.FaultGroupIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/FH_FaultAnalyzer/FaultGroupIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = FH_FaultAnalyzer.FaultGroupIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			FaultGroupIterator_IOperations _localServant = (FaultGroupIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, FH_FaultAnalyzer.FaultGroupList_THolder faultGroupList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,faultGroupList);
			}
			finally
			{
				_servant_postinvoke(_so);
