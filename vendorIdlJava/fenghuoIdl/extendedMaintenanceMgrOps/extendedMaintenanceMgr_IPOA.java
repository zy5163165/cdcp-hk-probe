	...
	implements org.omg.CORBA.portable.InvokeHandler, extendedMaintenanceMgrOps.extendedMaintenanceMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "performMaintenanceOperation", new java.lang.Integer(5));
	}
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedMaintenanceMgrOps/extendedMaintenanceMgr_I:1.0","IDL:mtnm.tmforum.org/common/Common_I:1.0"};
