...
public final class FDFrRoute_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(flowDomainFragment.FDFrRoute_THelper.id(), "FDFrRoute_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, flowDomainFragment.MatrixFlowDomainFragment_THelper.type()));
		}
		return _type;
	}
	...
	public static flowDomainFragment.MatrixFlowDomainFragment_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new flowDomainFragment.MatrixFlowDomainFragment_T[_l_result25];
