...
public abstract class MFDFrIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, flowDomainFragment.MFDFrIterator_IOperations
{
	...
	private String[] ids = {"IDL:mtnm.tmforum.org/flowDomainFragment/MFDFrIterator_I:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				flowDomainFragment.MatrixFlowDomainFragmentList_THolder _arg1= new flowDomainFragment.MatrixFlowDomainFragmentList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				flowDomainFragment.MatrixFlowDomainFragmentList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
