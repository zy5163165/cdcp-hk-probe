...
public class _MFDFrIterator_IStub
	...
	implements flowDomainFragment.MFDFrIterator_I
{
	...
	public final static java.lang.Class _opsClass = flowDomainFragment.MFDFrIterator_IOperations.class;
	...
	public boolean next_n(int how_many, flowDomainFragment.MatrixFlowDomainFragmentList_THolder mfdfrList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				mfdfrList.value = flowDomainFragment.MatrixFlowDomainFragmentList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
