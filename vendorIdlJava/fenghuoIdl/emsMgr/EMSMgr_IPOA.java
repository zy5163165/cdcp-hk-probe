	...
	implements org.omg.CORBA.portable.InvokeHandler, emsMgr.EMSMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getAllMLSNPPLinksWithTP", new java.lang.Integer(31));
		m_opsHash.put ( "getAllASAPs", new java.lang.Integer(32));
		m_opsHash.put ( "getAllMLSNPPs", new java.lang.Integer(33));
		m_opsHash.put ( "assignASAP", new java.lang.Integer(34));
		m_opsHash.put ( "getAllTopLevelTopologicalLinkNames", new java.lang.Integer(35));
		m_opsHash.put ( "createTopologicalLink", new java.lang.Integer(36));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 31: // getAllMLSNPPLinksWithTP
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
			...
			case 35: // getAllTopLevelTopologicalLinkNames
			{
			try
			{
				int _arg0=_input.read_ulong();
