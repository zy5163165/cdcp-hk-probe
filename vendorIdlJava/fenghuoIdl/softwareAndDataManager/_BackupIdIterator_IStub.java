...
public class _BackupIdIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements softwareAndDataManager.BackupIdIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/softwareAndDataManager/BackupIdIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = softwareAndDataManager.BackupIdIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			BackupIdIterator_IOperations _localServant = (BackupIdIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, softwareAndDataManager.BackupIdList_THolder backupList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,backupList);
			}
			finally
			{
				_servant_postinvoke(_so);
