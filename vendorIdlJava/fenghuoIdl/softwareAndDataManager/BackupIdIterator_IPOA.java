...
public abstract class BackupIdIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, softwareAndDataManager.BackupIdIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				softwareAndDataManager.BackupIdList_THolder _arg1= new softwareAndDataManager.BackupIdList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				softwareAndDataManager.BackupIdList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
