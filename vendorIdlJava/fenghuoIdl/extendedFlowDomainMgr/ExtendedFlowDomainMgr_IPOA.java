	...
	implements org.omg.CORBA.portable.InvokeHandler, extendedFlowDomainMgr.ExtendedFlowDomainMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "deleteExMFdFrs", new java.lang.Integer(2));
		m_opsHash.put ( "adjustmentFdFrRoute", new java.lang.Integer(3));
		m_opsHash.put ( "setAdditionalInfo", new java.lang.Integer(4));
		m_opsHash.put ( "getAllExMFdFrInMeSingleMeRoute", new java.lang.Integer(5));
		m_opsHash.put ( "createExMFdFr", new java.lang.Integer(6));
		m_opsHash.put ( "getPreCutOverFdFr", new java.lang.Integer(7));
		m_opsHash.put ( "deActivateFdFrs", new java.lang.Integer(8));
		m_opsHash.put ( "getCapabilities", new java.lang.Integer(9));
		m_opsHash.put ( "activateFdFrs", new java.lang.Integer(10));
		m_opsHash.put ( "getAllExMFdFrInMe", new java.lang.Integer(11));
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(12));
		m_opsHash.put ( "modifyFdFr", new java.lang.Integer(13));
		m_opsHash.put ( "deActivateExMFdFrs", new java.lang.Integer(14));
		m_opsHash.put ( "activateExMFdFrs", new java.lang.Integer(15));
		m_opsHash.put ( "getExFDFrRoute", new java.lang.Integer(16));
		m_opsHash.put ( "modifyExMFdFr", new java.lang.Integer(17));
		m_opsHash.put ( "createPreCutOverFdFr", new java.lang.Integer(18));
		m_opsHash.put ( "deleteFdFrs", new java.lang.Integer(19));
		m_opsHash.put ( "createFdFr", new java.lang.Integer(20));
	}
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedFlowDomainMgr/ExtendedFlowDomainMgr_I:1.0","IDL:mtnm.tmforum.org/common/Common_I:1.0"};
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 5: // getAllExMFdFrInMeSingleMeRoute
			{
			try
			{
				globaldefs.NameAndStringValue_T[] _arg0=globaldefs.NVSList_THelper.read(_input);
