...
public class _ExMegEntityIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedFlowDomainMgr.ExMegEntityIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org.fiberhome.extended/extendedFlowDomainMgr/ExMegEntityIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = extendedFlowDomainMgr.ExMegEntityIterator_IOperations.class;
	public int getLength() throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			ExMegEntityIterator_IOperations _localServant = (ExMegEntityIterator_IOperations)_so.servant;
			int _result;			try
			{
	...
	public boolean next_n(int how_many, extendedFlowDomainMgr.ExMegEntityList_THolder megList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				megList.value = extendedFlowDomainMgr.ExMegEntityList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,megList);
			}
			finally
			{
				_servant_postinvoke(_so);
