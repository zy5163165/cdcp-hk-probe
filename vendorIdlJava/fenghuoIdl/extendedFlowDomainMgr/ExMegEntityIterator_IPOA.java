...
public abstract class ExMegEntityIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, extendedFlowDomainMgr.ExMegEntityIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				extendedFlowDomainMgr.ExMegEntityList_THolder _arg1= new extendedFlowDomainMgr.ExMegEntityList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				extendedFlowDomainMgr.ExMegEntityList_THelper.write(_out,_arg1.value);
			}
			catch(globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
