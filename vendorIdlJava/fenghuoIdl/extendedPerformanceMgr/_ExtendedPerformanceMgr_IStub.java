...
public class _ExtendedPerformanceMgr_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements extendedPerformanceMgr.ExtendedPerformanceMgr_I
{
	...
	public final static java.lang.Class _opsClass = extendedPerformanceMgr.ExtendedPerformanceMgr_IOperations.class;
	public void createPMP(performance.PMP_T pmpData) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "createPMP", true);
				performance.PMP_THelper.write(_os,pmpData);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "createPMP", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ExtendedPerformanceMgr_IOperations _localServant = (ExtendedPerformanceMgr_IOperations)_so.servant;
			try
			{
			_localServant.createPMP(pmpData);
			}
			finally
			{
	...
	public void clearPMData(extendedPerformanceMgr.PMTPPmNameSelect_T[] pmTPSelectList, extendedPerformanceMgr.PMTPPmNameList_THolder failedTPSelectList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				extendedPerformanceMgr.PMTPPmNameList_THelper.write(_os,pmTPSelectList);
				_is = _invoke(_os);
				failedTPSelectList.value = extendedPerformanceMgr.PMTPPmNameList_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
	...
	public void modifyPMP(performance.PMP_T pmpData) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "modifyPMP", true);
				performance.PMP_THelper.write(_os,pmpData);
				_is = _invoke(_os);
				return;
			}
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "modifyPMP", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ExtendedPerformanceMgr_IOperations _localServant = (ExtendedPerformanceMgr_IOperations)_so.servant;
			try
			{
			_localServant.modifyPMP(pmpData);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void removePMPs(globaldefs.NameAndStringValue_T[][] pmpNameList, globaldefs.NamingAttributesList_THolder failedPmpNameList) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "removePMPs", true);
				globaldefs.NamingAttributesList_THelper.write(_os,pmpNameList);
				_is = _invoke(_os);
				failedPmpNameList.value = globaldefs.NamingAttributesList_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "removePMPs", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ExtendedPerformanceMgr_IOperations _localServant = (ExtendedPerformanceMgr_IOperations)_so.servant;
			try
			{
			_localServant.removePMPs(pmpNameList,failedPmpNameList);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void getAllExtraPmp(globaldefs.NameAndStringValue_T[] meName, int how_many, performance.PMPList_THolder pmpList, performance.PMPIterator_IHolder pmpIt) throws globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getAllExtraPmp", true);
		...
		{
			org.omg.CORBA.portable.ServantObject _so = _servant_preinvoke( "getAllExtraPmp", _opsClass );
			if( _so == null )
				throw new org.omg.CORBA.UNKNOWN("local invocations not supported!");
			ExtendedPerformanceMgr_IOperations _localServant = (ExtendedPerformanceMgr_IOperations)_so.servant;
			try
			{
			_localServant.getAllExtraPmp(meName,how_many,pmpList,pmpIt);
			}
			finally
			{
				_servant_postinvoke(_so);
