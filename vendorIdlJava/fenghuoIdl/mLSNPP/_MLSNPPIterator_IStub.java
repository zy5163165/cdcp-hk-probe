...
public class _MLSNPPIterator_IStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements mLSNPP.MLSNPPIterator_I
{
	private String[] ids = {"IDL:mtnm.tmforum.org/mLSNPP/MLSNPPIterator_I:1.0"};
	public String[] _ids()
	{
		return ids;
	}

	public final static java.lang.Class _opsClass = mLSNPP.MLSNPPIterator_IOperations.class;
	public boolean next_n(int how_many, mLSNPP.MLSNPPList_THolder mLSNPPList) throws globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			MLSNPPIterator_IOperations _localServant = (MLSNPPIterator_IOperations)_so.servant;
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,mLSNPPList);
			}
			finally
			{
