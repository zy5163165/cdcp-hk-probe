...
public abstract class MLSNPPIterator_IPOA
	extends org.omg.PortableServer.Servant
	implements org.omg.CORBA.portable.InvokeHandler, mLSNPP.MLSNPPIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				mLSNPP.MLSNPPList_THolder _arg1= new mLSNPP.MLSNPPList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				mLSNPP.MLSNPPList_THelper.write(_out,_arg1.value);
			}
