...
public final class FTPCreateData_THelper
{
	...
	public static flowDomain.FTPCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		...
		result.ingressTransmissionDescriptorName = globaldefs.NVSList_THelper.read(in);
		result.egressTransmissionDescriptorName = globaldefs.NVSList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final flowDomain.FTPCreateData_T s)
	{
		...
		globaldefs.NVSList_THelper.write(out,s.ingressTransmissionDescriptorName);
		globaldefs.NVSList_THelper.write(out,s.egressTransmissionDescriptorName);
