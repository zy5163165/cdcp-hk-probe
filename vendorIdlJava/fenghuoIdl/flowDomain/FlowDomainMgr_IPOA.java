	...
	implements org.omg.CORBA.portable.InvokeHandler, flowDomain.FlowDomainMgr_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "modifyFlowDomain", new java.lang.Integer(21));
		m_opsHash.put ( "getAllFDFrs", new java.lang.Integer(22));
		m_opsHash.put ( "getFDFrsWithTP", new java.lang.Integer(23));
		m_opsHash.put ( "getAllAssignableCPTPs", new java.lang.Integer(24));
		m_opsHash.put ( "setUserLabel", new java.lang.Integer(25));
		m_opsHash.put ( "deAssociateCPTPsFromFlowDomain", new java.lang.Integer(26));
		m_opsHash.put ( "deleteFTP", new java.lang.Integer(27));
		m_opsHash.put ( "getMFD", new java.lang.Integer(28));
		m_opsHash.put ( "modifyMFD", new java.lang.Integer(29));
		m_opsHash.put ( "getFDFrsByUserLabel", new java.lang.Integer(30));
		m_opsHash.put ( "createFlowDomain", new java.lang.Integer(31));
		m_opsHash.put ( "getTransmissionParams", new java.lang.Integer(32));
		m_opsHash.put ( "getFDFr", new java.lang.Integer(33));
		m_opsHash.put ( "getAllCPTPs", new java.lang.Integer(34));
		m_opsHash.put ( "createFTP", new java.lang.Integer(35));
		m_opsHash.put ( "getFlowDomainsByUserLabel", new java.lang.Integer(36));
		m_opsHash.put ( "getAllAssociatedMFDs", new java.lang.Integer(37));
		m_opsHash.put ( "createAndActivateFDFr", new java.lang.Integer(38));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 36: // getFlowDomainsByUserLabel
			{
			try
			{
				java.lang.String _arg0=_input.read_string();
